...
from research.analyze_final_evaluation import INTERRUPTION_CASES, analyze, reproduce_tables
from solar_recovery.pilot import digest


def test_final_analysis_artifacts_on_synthetic_two_site_grid(tmp_path):
