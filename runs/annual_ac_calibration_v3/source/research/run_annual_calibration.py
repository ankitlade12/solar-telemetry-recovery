...
METHODS = ["raw", "rolling", "recency", "physical", "physical_recovery", "mask50", "aci_bounded"]


def causal_forecasts(features, bases, events, contract, parameters):
    calibrators = {name: (ContextCalibrator(name, **parameters) if name in {"physical", "physical_recovery", "mask50"}
