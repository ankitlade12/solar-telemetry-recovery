"""Independent arithmetic/receipt checks on frozen final artifacts.
...
from research.release_protocol import verification_protocol
...
if __name__ == "__main__":
    ...
    parser.add_argument("--release-lock", help="Explicit validated public dependency view; default requires original private PRD")
