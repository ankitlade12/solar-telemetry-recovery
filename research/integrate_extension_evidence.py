...
def main(output_path='paper/integrated_evidence_v2'):
    workspace = Path.cwd().resolve(); output = Path(output_path).resolve()
    if not output.is_relative_to(workspace): raise ValueError('Output must be inside the workspace')
...
if __name__=='__main__':
    ...
    parser.add_argument('--output', default='paper/integrated_evidence_v2')
