...
from research.extension_release_protocol import PARENT, PUBLIC
...
def main():
    ...
    parser.add_argument('--stage', default='/private/tmp/solar-extension-public-closure-v2')
    parser.add_argument('--output', default='runs/public_extension_dependency_check_v2')
    ...
    extra = [str(PARENT), str(PUBLIC), 'research/extension_release_protocol.py', 'research/reproduce_public_extension.py',
